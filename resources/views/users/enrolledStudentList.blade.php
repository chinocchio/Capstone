<x-layout>
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            {{-- Button to go to the MAC Laboratory Plot View --}}
            {{-- <a href="{{ route('mac.plot') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                View MAC Laboratory Plot
            </a> --}}
        </div>
